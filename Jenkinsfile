    ...
    stages{
        ...
        stage('Publish test report') {
            steps {
                ...
                slackSend message:"You can access the tests report by clicking http://3.233.167.141:8080/job/cd-api_test/$BUILD_NUMBER/Test_20report/ or checking your mail inbox"
